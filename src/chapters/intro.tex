...
Based on these ideas, this project is a development of low cost and easy to use EEG based BCI typing system. This system applies simple signal processing techniques like filtering and frequency analysis while avoiding or using few expensive equipment and advanced complex methods.
...
This project is also motivated by the desire to gain hands on experience in recording and processing EEG signals. Development of a basic BCI typing interface helped us understand real world challenges such as noisy signals, device limitations, market limitations, economic feasibility and so on. Overall, this project developed a BCI system with less complex machine learning or expensive equipment and simple approach to demonstrate the core ideas of brain computer interaction.


\section{Problem Statement}
Regular computer typing and interaction is dependent upon physical devices like keyboards and mice but these devices are not suitable for people with motor disabilities or situations that requires physical operation beyond capabilities of an individual. Brain-Computer Interface (BCI) systems can offer a solution but most of the existing EEG based BCI typing systems depend on expensive equipment, complex signal processing or machine learning models that needs large amount of data and long training which makes them difficult to use in low budget, academic or experimental environments.
