...
Transfer function are shown below representing the behavior of output signal. The transfer function was derived using nodal analysis based on standard active RC filter methods \cite{carter_opamp}.
Following is the first stage where the signal starts getting cleaned up.
